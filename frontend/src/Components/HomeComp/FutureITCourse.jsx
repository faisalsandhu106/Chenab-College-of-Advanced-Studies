...
const FutureITCourse = () => {
    const { isITcourseLoading, futureITcourse } = UseCourseContext();
    ...
    //* Loading State
    if (isITcourseLoading || futureITcourse.length === 0) {
        return (
            <div className='grid xs:grid-cols-1 md:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 justify-items-center pt-6 lg:px-3 xl:px-0 md:gap-x-5 lg:gap-x-5 xl:gap-x-9 xs:gap-y-10 w-full'>
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className='grid xs:grid-cols-1 md:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 justify-items-center pt-6 xs:px-1 md:px-4 lg:px-6 xl:px-20 md:gap-x-7 xl:gap-x-9 xs:gap-y-12 lg:gap-y-14  w-full'>
            {
                futureITcourse.map((items) => {
